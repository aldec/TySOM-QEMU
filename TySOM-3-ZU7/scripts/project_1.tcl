...
#
# Generated by Vivado on Wed Oct 25 16:38:10 CEST 2023
...
#
#    "/storage/zbyszek/storage_0/_git/TySOM-QEMU/TySOM-3-ZU7/src/constr.xdc"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../src/constr.xdc"]"\
  ]
  foreach ifile $files {
...
set_property -name "board_part" -value "aldec.com:tysom_3_zu7:part0:1.2" -objects $obj
...
set_property -name "platform.board_id" -value "tysom_3_zu7" -objects $obj
...
set file "[file normalize "$origin_dir/../src/constr.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../src/constr.xdc"
...
MIO#NAND#GPIO1 MIO#GPIO1 MIO#I2C 0#I2C 0#UART 1#UART 1#DPAUX#DPAUX#DPAUX#DPAUX#SD 0#PCIE#SD 0#SD 0#SD 0#SD 0#SD 0#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#Gem 2#Gem 2#Gem 2#Gem 2#Gem 2#Gem 2#Gem 2#Gem 2#Gem\
2#Gem 2#Gem 2#Gem 2#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#MDIO 2#MDIO 2} \
...
Firmware|SA:0xFD010000 ;SIZE:64;UNIT:KB ;RegionTZ:Secure ;WrAllowed:Read/Write;subsystemId:PMU Firmware|SA:0xFD020000 ;SIZE:64;UNIT:KB ;RegionTZ:Secure ;WrAllowed:Read/Write;subsystemId:PMU Firmware|SA:0xFD030000\
;SIZE:64;UNIT:KB ;RegionTZ:Secure ;WrAllowed:Read/Write;subsystemId:PMU Firmware|SA:0xFD040000 ;SIZE:64;UNIT:KB ;RegionTZ:Secure ;WrAllowed:Read/Write;subsystemId:PMU Firmware|SA:0xFD050000 ;SIZE:64;UNIT:KB\
;RegionTZ:Secure ;WrAllowed:Read/Write;subsystemId:PMU Firmware|SA:0xFD610000 ;SIZE:512;UNIT:KB ;RegionTZ:Secure ;WrAllowed:Read/Write;subsystemId:PMU Firmware|SA:0xFD5D0000 ;SIZE:64;UNIT:KB ;RegionTZ:Secure\
...
\
  ...
  connect_bd_intf_net -intf_net axi_gpio_1_GPIO [get_bd_intf_ports PL_leds] [get_bd_intf_pins axi_gpio_1/GPIO]
  ...
  connect_bd_net -net rst_ps8_0_50M_peripheral_aresetn [get_bd_pins rst_ps8_0_50M/peripheral_aresetn] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/M01_ARESETN]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_50M/slowest_sync_clk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins ps8_0_axi_periph/M01_ACLK]
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"0.855093",
   "Default View_TopLeft":"11,-98",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.5.8 2022-09-21 7111 VDI=41 GEI=38 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace port PL_user_switches -pg 1 -lvl 4 -x 1230 -y 310 -defaultsOSRD
preplace port PL_leds -pg 1 -lvl 4 -x 1230 -y 170 -defaultsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 1 -x 340 -y 100 -defaultsOSRD
preplace inst axi_gpio_0 -pg 1 -lvl 3 -x 1100 -y 310 -defaultsOSRD
preplace inst axi_gpio_1 -pg 1 -lvl 3 -x 1100 -y 170 -defaultsOSRD
preplace inst ps8_0_axi_periph -pg 1 -lvl 2 -x 820 -y 140 -defaultsOSRD
preplace inst rst_ps8_0_50M -pg 1 -lvl 1 -x 340 -y 310 -defaultsOSRD
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 0 3 20 210 660 280 990
preplace netloc zynq_ultra_ps_e_0_pl_resetn0 1 0 2 30 200 650
preplace netloc rst_ps8_0_50M_peripheral_aresetn 1 1 2 670 290 970
preplace netloc axi_gpio_0_GPIO 1 3 1 NJ 310
preplace netloc axi_gpio_1_GPIO 1 3 1 NJ 170
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM0_FPD 1 1 1 N 60
preplace netloc ps8_0_axi_periph_M00_AXI 1 2 1 980 130n
preplace netloc ps8_0_axi_periph_M01_AXI 1 2 1 N 150
levelinfo -pg 1 0 340 820 1100 1230
pagesize -pg 1 -db -bbox -sgen 0 0 1410 410
"
}
